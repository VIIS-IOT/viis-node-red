...
class FanControlService {
    ...
    async processRotationMode(config) {
        try {
            ...
            if (!(0, groupUtils_1.supportsRotation)(groupSize)) {
                ...
                return (0, groupUtils_1.createOptimizedFanGroupActions)(targetGroup, true, `Single group mode: no rotation needed`, coilMapping, currentDeviceStatus);
            }
    ...
    async processThresholdMode(config, sensorData, deviceStatus) {
        try {
            ...
            if (currentActiveFanCount === requiredGroupSize && requiredGroupSize > 0) {
                ...
                if ((0, groupUtils_1.supportsRotation)(requiredGroupSize)) {
