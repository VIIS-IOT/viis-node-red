...
describe("validateResolvedConfig", () => {
    ...
    it("fails when a poll key is missing from every board or mapped on two boards", () => {
        const missing = (0, config_validator_1.validateResolvedConfig)({
            deviceId: "device-1",
            boardId: "board1",
            pollingConfig: {
        ...
        const collision = (0, config_validator_1.validateResolvedConfig)({
            deviceId: "device-1",
            boardId: "board1",
            pollingConfig: {
        ...
        expect(collision.errors).toContain('realtime.coils key "power" is mapped on multiple boards: board1, board2');
    });
});
