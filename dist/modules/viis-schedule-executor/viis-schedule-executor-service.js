    ...
    reExecuteAfterPowerLoss(modbusClient, schedule) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const cmd of holdingCommandsToCheck) {
                try {
                    const readResult = yield modbusClient.readHoldingRegisters(cmd.address, 1);
                    const rawValue = Number(readResult.data[0]);
            ...
            for (const cmd of coilCommandsToCheck) {
                try {
                    const readResult = yield modbusClient.readCoils(cmd.address, 1);
            ...
            const writeSuccess = yield this.verifyModbusWrite(modbusClient, [...holdingCommandsToExecute, ...coilCommandsToExecute]);
            if (writeSuccess) {
