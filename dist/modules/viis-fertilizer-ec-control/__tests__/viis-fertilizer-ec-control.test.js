...
const ContextWindowService_1 = require("../services/ContextWindowService");
...
const createMockNode = () => {
    ...
    const statusUpdates = [];
    return {
        send: jest.fn((msg) => messages.push(msg)),
        error: jest.fn((msg) => errors.push(msg)),
        warn: jest.fn((msg) => warnings.push(msg)),
        log: jest.fn(),
        status: jest.fn((status) => statusUpdates.push(status)),
        on: jest.fn(),
        _messages: messages,
        _errors: errors,
        _warnings: warnings,
...
describe('ViisfertilizerEcControl - Core Functions', () => {
    describe('ContextWindowService', () => {
        ...
        beforeEach(() => {
            ...
            service = new ContextWindowService_1.ContextWindowService(mockNode, {
                windowSize: 5,
    ...
    describe('Valve Time Validation', () => {
        it('should validate valve times are within bounds', () => {
            const maxValveTime = constants_1.EC_CONTROL_DEFAULTS.MAX_VALVE_TIME;
            const minValveTime = 100;
            const validateValveTimes = (times) => {
    ...
    describe('Global Context Data Reading', () => {
        ...
        it('should detect stale data correctly', () => {
            const maxAge = constants_1.EC_CONTROL_DEFAULTS.GLOBAL_DATA_MAX_AGE;
            const now = Date.now();
            // Fresh data
        ...
        it('should extract sensor readings from global context', () => {
            ...
            const readings = {
                ...
                current_flow_1: Number((_a = holdingData.current_flow_1) !== null && _a !== void 0 ? _a : 0),
                current_flow_2: Number((_b = holdingData.current_flow_2) !== null && _b !== void 0 ? _b : 0),
                current_flow_3: Number((_c = holdingData.current_flow_3) !== null && _c !== void 0 ? _c : 0),
                current_flow_4: Number((_d = holdingData.current_flow_4) !== null && _d !== void 0 ? _d : 0),
                current_flow_5: Number((_e = holdingData.current_flow_5) !== null && _e !== void 0 ? _e : 0),
            };
