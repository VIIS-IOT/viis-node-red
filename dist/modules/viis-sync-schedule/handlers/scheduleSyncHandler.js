...
class ScheduleSyncHandler {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const serverPlan of serverPlans) {
                    yield this.syncSchedulePlan(serverPlan);
                }
                // Create sync result
     ...
     */
    syncSchedulePlan(serverPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                logger_1.logger.info(this.node, `Syncing schedule plan: ${serverPlan.name} (${serverPlan.label})`);
                // Check if plan exists locally
                const localPlan = yield this.planRepo.findOneBy({ name: serverPlan.name });
                if (!localPlan) {
                    // Plan doesn't exist locally, create it
                    yield this.createSchedulePlan(serverPlan);
                }
                else {
                    // Plan exists locally, check if it needs updating
                    yield this.updateSchedulePlanIfNeeded(localPlan, serverPlan);
                }
                // Sync schedules for this plan
                yield this.syncSchedulesForPlan(serverPlan);
    ...
    createSchedulePlan(serverPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                newPlan.status = serverPlan.status;
                ...
                yield this.planRepo.save(newPlan);
     ...
     */
    updateSchedulePlanIfNeeded(localPlan, serverPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.planRepo.save(localPlan);
     ...
     */
    syncSchedulesForPlan(serverPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.detectDeletedSchedules(schedules, serverPlan.name);
                // Process each schedule
                for (const serverSchedule of schedules) {
                    yield this.syncSchedule(serverSchedule, serverPlan.name);
                }
     ...
     */
    syncSchedule(serverSchedule, planName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                logger_1.logger.info(this.node, `Syncing schedule: ${serverSchedule.name}`);
                // Check if schedule exists locally
                const localSchedule = yield this.scheduleRepo.findOneBy({ name: serverSchedule.name });
                if (!localSchedule) {
                    // Schedule doesn't exist locally, create it
                    yield this.createSchedule(serverSchedule, planName);
                }
                else {
                    // Schedule exists locally, check if it needs updating
                    yield this.updateScheduleIfNeeded(localSchedule, serverSchedule);
                }
     ...
     */
    createSchedule(serverSchedule, planName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.scheduleRepo.save(newSchedule);
     ...
     */
    updateScheduleIfNeeded(localSchedule, serverSchedule) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.scheduleRepo.save(localSchedule);
     ...
     */
    detectDeletedSchedules(serverSchedules, planName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const localSchedules = yield this.scheduleRepo.find({
                    where: {
                ...
                for (const deletedSchedule of deletedSchedules) {
                    ...
                    yield this.scheduleRepo.save(deletedSchedule);
                    this.syncStats.schedulesUpdated++;
                    this.syncStats.totalSchedules++;
                }
