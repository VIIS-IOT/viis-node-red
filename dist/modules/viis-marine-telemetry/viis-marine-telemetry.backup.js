...
module.exports = function (RED) {
    ...
    function ViisMarinetTelemetryNode(config) {
        ...
        (async () => {
            try {
                ...
                setupCleanupHandler(node, pollingService, connectionManager, thingsboardMqttClient, dh6400PollingService, flowContext, debugLogKey, thresholdConfigKey, isMultiBoardMode, currentBoardId, dataSource);
    ...
    function setupCleanupHandler(node, pollingService, connectionManager, thingsboardMqttClient, dh6400PollingService, flowContext, debugLogKey, thresholdConfigKey, isMultiBoardMode, currentBoardId, dataSource) {
