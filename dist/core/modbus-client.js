    ...
    initializeClient() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus: Connection failed for type ${this.config.type}: ${error.message}`); // Log connection error
    ...
    scheduleReconnect() {
        ...
        this.reconnectTimer = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus TCP: Reconnection attempt failed: ${error.message}`); // Log reconnect error
                this.handleError(error);
                this.scheduleReconnect();
            }
    ...
    readCoils(address, length) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus: Error reading Coils at address ${address}, length ${length}: ${error.message}`);
                this.handleError(error);
                throw error;
            }
        });
    ...
    readInputRegisters(address, length) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus: Error reading Input Registers at address ${address}, length ${length}: ${error.message}`);
                this.handleError(error);
                throw error;
            }
        });
    ...
    readHoldingRegisters(address, length) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus: Error reading Holding Registers at address ${address}, length ${length}: ${error.message}`);
                this.handleError(error);
                throw error;
            }
        });
    ...
    writeRegister(address, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus: Error writing Holding Register at address ${address}, value ${value}: ${error.message}`); // Log write error
                this.handleError(error);
                throw error;
            }
        });
    ...
    writeCoil(address, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.node.log(`Modbus: Error writing Coil at address ${address}, value ${value}: ${error.message}`);
                this.handleError(error);
                throw error;
            }
        });
