...
describe('OilProfileService', () => {
    ...
    beforeAll(async () => {
        ...
        dataSource = new typeorm_1.DataSource({
            ...
            entities: [TabiotOilProfile_1.TabiotOilProfile, TabiotDevice_1.TabiotDevice],
            synchronize: true, // Auto-create tables for testing
            dropSchema: true, // Clean slate for each test run
        });
        await dataSource.initialize();
        service = new OilProfileService_1.OilProfileService(dataSource);
    });
    afterAll(async () => {
    ...
    describe('createProfile', () => {
        ...
        it('should create active profile and deactivate others', async () => {
            ...
            expect(updatedProfile1 === null || updatedProfile1 === void 0 ? void 0 : updatedProfile1.is_active).toBe(false);
        });
    ...
    describe('setActiveProfile', () => {
        it('should activate profile and deactivate others', async () => {
            ...
            expect(profile1 === null || profile1 === void 0 ? void 0 : profile1.is_active).toBe(false);
            expect(profile2 === null || profile2 === void 0 ? void 0 : profile2.is_active).toBe(true);
        });
        it('should throw error for non-existent profile', async () => {
            await expect(service.setActiveProfile('non_existent_profile')).rejects.toThrow('Profile non_existent_profile not found');
        });
    });
    describe('getActiveProfile', () => {
        it('should return active profile', async () => {
            ...
            expect(activeProfile === null || activeProfile === void 0 ? void 0 : activeProfile.name).toBe('active_profile');
            expect(activeProfile === null || activeProfile === void 0 ? void 0 : activeProfile.is_active).toBe(true);
        });
