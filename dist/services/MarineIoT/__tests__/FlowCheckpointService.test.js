...
describe('FlowCheckpointService', () => {
    ...
    beforeEach(() => {
        ...
        service = new FlowCheckpointService_1.FlowCheckpointService(mockDataSource);
    });
    describe('updateCheckpoint', () => {
        it('should calculate positive delta when checkpoint exists', async () => {
            ...
            mockRepo.save.mockResolvedValue(Object.assign(Object.assign({}, existingCheckpoint), { last_tfs_value: 110.5 }));
        ...
        it('should detect reset when delta is negative', async () => {
            ...
            mockRepo.findOne.mockResolvedValue(existingCheckpoint);
            mockRepo.save.mockResolvedValue(Object.assign(Object.assign({}, existingCheckpoint), { last_tfs_value: 5.0 }));
            const result = await service.updateCheckpoint({
                deviceId: 'device_001',
                sensorKey: 'tfs01',
