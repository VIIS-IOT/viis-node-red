...
describe('FlowAccumulationService - TFS Reset Handling', () => {
    ...
    let mockOilProfileRepo;
    let mockAccumulationRepo;
    beforeEach(() => {
        // Mock repositories
        mockTelemetryRepo = {
        ...
        mockDataSource = {
            getRepository: jest.fn((entity) => {
                if (entity === TabiotDeviceTelemetry_1.TabiotDeviceTelemetry)
                    return mockTelemetryRepo;
                if (entity === TabiotOilProfile_1.TabiotOilProfile)
                    return mockOilProfileRepo;
                return mockAccumulationRepo;
            })
        };
        service = new FlowAccumulationService_1.FlowAccumulationService(mockDataSource);
    });
