...
describe('Error Management System - Integration Tests', () => {
    ...
    describe('End-to-End Modbus Error Flow', () => {
        it('should parse Modbus error and return complete error information', () => {
            ...
            expect(result?.message).toBe('Nhiệt độ vượt ngưỡng an toàn');
        ...
        it('should fallback to default mapping for unknown device type', () => {
            ...
            expect(result).not.toBeNull();
            expect(result?.err_code).toBe('ERR_GENERAL');
            expect(result?.message).toBe('General system error');
        });
    ...
    describe('Auto-Resolve Logic', () => {
        it('should identify auto-resolvable errors', () => {
            ...
            const shouldResolve = errorMappingService.shouldAutoResolve(
                source,
                'Climate_Controller'
            );
    ...
    describe('Device Type Discovery', () => {
        ...
        it('should retrieve mapping for specific device type', () => {
            ...
            expect(mapping?.device_type).toBe('Climate_Controller');
    ...
    describe('Error Scenarios', () => {
        ...
        it('should handle missing global context mappings', () => {
            ...
            const service = new ErrorMappingService(emptyContext);
            
            const result = service.parseModbusError(
    ...
    describe('Real-World Scenarios', () => {
        it('should handle temperature alarm lifecycle', () => {
            ...
            expect(error?.err_code).toBe('ERR_TEMP_HIGH');
            expect(error?.auto_resolve).toBe(true);
        ...
        it('should handle sensor fault lifecycle', () => {
            ...
            expect(error?.err_code).toBe('ERR_TEMP_SENSOR_FAULT');
            expect(error?.severity).toBe('critical');
            expect(error?.auto_resolve).toBe(false); // Requires manual intervention
