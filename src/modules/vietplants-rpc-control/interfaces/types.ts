...
export interface IModbusService {
    ...
    // Multi-board methods for vietplants-rpc-control
    getBoard2Client(): Promise<any>;
    findModbusMappingForBoard(key: string, boardId: string): ModbusMappingResult | null;
    writeToModbusBoard(key: string, mapping: ModbusMappingResult, value: number | boolean, boardId: string): Promise<void>;
    readFromModbusBoard(key: string, mapping: ModbusMappingResult, boardId: string): Promise<number | boolean>;
}
