...
import { ProtectionManager, CoilProtectionConfig } from '../protection-manager';
import { ConfigService } from '../services/configService';

// Mock Node-RED context
const createMockContext = (globalData: Record<string, any> = {}) => ({
    global: {
        get: jest.fn((key: string) => globalData[key] || null),
        set: jest.fn(),
    },
    flow: {
        get: jest.fn(),
...
// Mock Node-RED node
const createMockNode = (contextData: Record<string, any> = {}) => ({
...
describe('VIIS Device Protection', () => {
    ...
    describe('ProtectionManager', () => {
        ...
        describe('Bypass Protection', () => {
            it('should allow all operations when bypass is enabled', () => {
                const config: CoilProtectionConfig = {
                    maxTimeOn: 60,
                    minTimeOn: 10,
                    minOffTime: 30,
                    bypass: true,
        ...
        describe('Sensor-based Protection', () => {
            ...
            it('should include sensor value in metadata', () => {
                ...
                expect(result.metadata?.sensorValue).toBe(35);
            });
        });
        ...
        describe('Multi-device Independence', () => {
            ...
            it('should handle multiple devices independently', () => {
                const config1: CoilProtectionConfig = {
                    maxTimeOn: 10,
                    minTimeOn: 0,
                    minOffTime: 0,
                    bypass: false,
                ...
                const config2: CoilProtectionConfig = {
                    maxTimeOn: 20,
                    minTimeOn: 0,
                    minOffTime: 0,
                    bypass: false,
    ...
    describe('ConfigService', () => {
        it('should get config key values from global context', () => {
            ...
            const configService = new ConfigService(mockNode as any);
