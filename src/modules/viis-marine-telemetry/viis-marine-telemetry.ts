...
module.exports = function (RED: NodeAPI) {
     ...
     */
    function createDH6400Config(globalHelper: GlobalContextHelper, config: ViisMarinetTelemetryNodeDef): DH6400PollingConfig {
     ...
     */
    function setupDH6400EventHandlers(
        node: Node,
    ...
    function setupCleanupHandler(
        node: Node,
        thingsboardMqttClient: MqttClientCore | null,
