...
describe('ScheduleService - Falsy Value Handling', () => {
    ...
    describe('storeConfigParameter - Falsy value handling', () => {
        it('should return null for value 0', () => {
            const result = (scheduleService as any).storeConfigParameter('test_key', 0, 'test-schedule');
        ...
        it('should return null for value false', () => {
            const result = (scheduleService as any).storeConfigParameter('test_key', false, 'test-schedule');
            expect(result).toBeNull();
        });
        ...
        it('should store truthy number values', () => {
            const result = (scheduleService as any).storeConfigParameter('test_key', 42, 'test-schedule');
        ...
        it('should store truthy boolean values', () => {
            const result = (scheduleService as any).storeConfigParameter('test_key', true, 'test-schedule');
            expect(result).not.toBeNull();
            expect(result).toMatchObject({
                key: 'test_key',
                value: true,
        ...
        it('should store truthy string values', () => {
            const result = (scheduleService as any).storeConfigParameter('test_key', "valid_value", 'test-schedule');
            expect(result).not.toBeNull();
            expect(result).toMatchObject({
                key: 'test_key',
                value: "valid_value",
