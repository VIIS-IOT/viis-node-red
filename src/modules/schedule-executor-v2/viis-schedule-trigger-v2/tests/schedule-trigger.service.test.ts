...
import { TabiotSchedule } from '../../common/types';
...
jest.mock('../../../../orm/dataSource', () => ({
    AppDataSource: {
        ...
        initialize: jest.fn().mockImplementation(() => {
            (global as any).AppDataSourceInitialized = true;
...
describe('ScheduleTriggerService', () => {
    ...
    beforeEach(() => {
        ...
        service = new ScheduleTriggerService(mockNode, true);
    });

    describe('Constructor', () => {
        it('should initialize with debug enabled', () => {
            const debugService = new ScheduleTriggerService(mockNode, true);
            expect(debugService).toBeDefined();
        });

        it('should initialize with debug disabled', () => {
            const nonDebugService = new ScheduleTriggerService(mockNode, false);
    ...
    describe('isScheduleDue - Time-based checks', () => {
        it('should return true when current time is within schedule range', () => {
            ...
            const testSchedule: TabiotSchedule = {
                name: 'test-schedule',
                label: 'Test Schedule',
                status: 'finished',
                start_time: '08:00:00',
        ...
        it('should return false when schedule is disabled (enable !== 1)', () => {
            const disabledSchedule: TabiotSchedule = {
    ...
    describe('isScheduleDue - Date range checks', () => {
        it('should return false when current date is outside start_date and end_date range', () => {
            const scheduleWithDateRange: TabiotSchedule = {
    ...
    describe('isScheduleDue - Interval (day of week) checks', () => {
        it('should handle single day interval', () => {
            const scheduleWithInterval: TabiotSchedule = {
        ...
        it('should handle invalid interval gracefully (fallback to allow)', () => {
            const scheduleWithInvalidInterval: TabiotSchedule = {
    ...
    describe('getDueSchedules - Database queries', () => {
        it('should return empty array when DEVICE_ID is not set', async () => {
            ...
            expect(mockNode.warn).toHaveBeenCalledWith(
                expect.stringContaining('No DEVICE_ID found')
            );
        });

        it('should return schedules from database', async () => {
            const mockSchedules: TabiotSchedule[] = [
                {
                    name: 'schedule-1',
                    label: 'Schedule 1',
                    status: 'finished',
    ...
    describe('filterDueSchedules', () => {
        it('should filter and return only due schedules', () => {
            const schedules: TabiotSchedule[] = [
                {
                    name: 'due-schedule',
                    label: 'Due Schedule',
                    status: 'finished',
    ...
    describe('Timestamp management', () => {
        ...
        it('should update last check timestamp for a schedule', () => {
            ...
            const globalContext = (mockNode.context().global as any);
            expect(globalContext.set).toHaveBeenCalledWith(
    ...
    describe('Edge cases', () => {
        it('should handle cross-midnight schedules', () => {
            const crossMidnightSchedule: TabiotSchedule = {
        ...
        it('should handle leap year dates', () => {
            const leapYearSchedule: TabiotSchedule = {
